...
<fieldset id="cites">
    ...
    <ul>
        <li><strong><abbr title="American Psychological Association">APA</abbr>
                格式</strong>：<br /><small><?php post_cite_apa(); ?></small></li>
        ...
        <li><strong>EndNote 匯入格式</strong>：<a href="<?php post_endnotelink(); ?>" title="下載 EndNote 格式匯入檔案">下載</a><br />
            <small>下載後請在 EndNote 軟體中選擇「File」→ 「Import」功能匯入，並且在開啟檔案對話視窗中，將文字編碼設定為 Unicode（UTF-8），便可以在 EndNote
                中使用這篇文章的資料。</small>
        </li>
    </ul>
</fieldset>
