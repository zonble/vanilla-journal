...
<li <?php showactive('archive') ?>><a href="<?php info('url');?>volume.php" title="前期電子報索引">期數索引</a><?php show_archive_nav(); ?></li>
...
<li <?php showactive('about.php') ?>><a href="<?php info('url');?>index.php?file=about.php" title="關於我們">關於我們</a></li>
