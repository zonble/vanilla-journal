...
<form method="post" action="cats.php">
    <ul>
        ...
        <li>&nbsp;<label for="cat_name">名稱</label>： <input type="text" size="20" id="cat_name" name="cat_name"
                value="<?php echo $cat_name; ?>" /> </li>
        <li>&nbsp;<label for="cat_desc">附註</label>： <input type="text" size="40" id="cat_desc" name="cat_desc"
                value="<?php echo $cat_desc; ?>" /> </li>
    </ul>
...
<form method="post">
    ...
    <table>
        <tr>
            <td class="options"><label for="password1">請輸入新密碼</label>：</td>
            <td><input type="password" size="20" name="password1" id="password1" /></td>
        </tr>
        <tr>
            <td class="options"><label for="password2">請再次確認您所輸入的密碼</label>：</td>
            <td><input type="password" size="20" name="password2" id="password2" /></td>
        </tr>
        <?php if($password) { ?>
        <tr>
            <td class="options"><label for="oldpassword">請輸入目前的密碼</label>：</td>
            <td><input type="password" size="20" name="oldpassword" id="oldpassword" /></td>
        </tr>
        <?php } ?>
        <tr>
            <td class="options">&nbsp;</td>
            <td><input type="submit" name="submit" value="修改密碼！" /></td>
        </tr>
    </table>
</form>
<?php
