...
<form method="post" action="attach-edit.php">
    ...
    <p>是否顯示在版面上？
        <input type="radio" name="display" value="1" id="dis1" <?php if ($attach->display)
                        echo ' checked="checked"'; ?> /> <label for="dis1">是</label>
        <input type="radio" name="display" value="0" id="dis0" <?php if (!$attach->display)
                        echo ' checked="checked"'; ?> /> <label for="dis0">否</label>
    </p>
...
<div>
    ...
    <ul style="font-size: 9pt;">
        ...
        <li>在別的地方使用本圖的 <abbr title="Hypertext Markup Language">HTML</abbr> 語法：<br />
            <textarea cols="70"
                style="font-size: 9pt; width: 90%; margin: 3px;"><?php $attach->image_html() ?></textarea>
            <?php } else { ?>
        <li>在別的地方使用這個檔案的 <abbr title="Hypertext Markup Language">HTML</abbr> 語法：<br />
            <textarea cols="70"
                style="font-size: 9pt; width: 90%; margin: 3px;"><?php $attach->link_html() ?></textarea>
            <?php } ?>
        </li>
    </ul>
</div>
