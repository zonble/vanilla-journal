...
<form method="post" action="attach-edit.php">
    ...
    <p>是否顯示在版面上？
        <input type="radio" name="display" value="1" id="dis1"
            <?php if($attach->display) echo ' checked="checked"';?> /> <label for="dis1">是</label>
        <input type="radio" name="display" value="0" id="dis0"
            <?php if(!$attach->display) echo ' checked="checked"';?> /> <label for="dis0">否</label>
    </p>
