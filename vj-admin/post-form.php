...
<small>如果有多位作者，請在作者名稱之間，用半形逗號隔開。</small></td>
</tr>
<tr>
<td class="post_options"><label for="author_desc">作者介紹</label>：</td>
<td><textarea name="author_desc" id="author_desc" rows="5" cols="20"><?php echo $author_desc; ?></textarea><br/>
<small>您可以在此為作者做簡單的介紹。</small></td>
</tr>
<tr>
<td class="post_options"><label for="keyword">關鍵字</label>：</td>
<td><textarea name="keyword" id="keyword"><?php echo $keyword; ?></textarea><br/>
<small>如果有多位關鍵字，請在關鍵字之間，用半形逗號隔開。</small></td>
</tr>
...
<small>您也可以在<a href="volume-edit.php?volume=<?php echo $volume?>">管理本期文章</a>頁面上，以拖拉方式快速調整整個單元中的文章次序。</small>
</td>
</tr>
<tr>
...
<tr>
  ...
  <td>
  <input type="radio" name="display" id="dis1" value="1" <?php if(!(empty($display))) {echo 'checked="checked"';} ?>/><label for="dis1">是、在網路上公開這篇文章</label><br/>
  <input type="radio" name="display" id="dis2" value="0" <?php if(empty($display)) {echo 'checked="checked"';}  ?>/><label for="dis2">否、不要在網路上公開這篇文章</label>
...
<td><input type="text" name="topic_ext" id="topic_ext" value="<?php echo $topic_ext; ?>" size="50"/></td>
</tr>

<tr>
<td class="post_options"><label for="abstract">摘要</label>：</td>
<td><textarea class="mceEditor" style="width: 95%" name="abstract" id="abstract" rows="5" cols="80"><?php echo $abstract; ?></textarea></td>
</tr>
<tr>
<td class="post_options"><label for="body">內文</label>：</td>
<td><textarea class="mceEditor" style="width: 95%" name="body" id="body" rows="15" cols="80"><?php echo $body; ?></textarea></td>
</tr>
</table>
</div>
<br clear="all" />
