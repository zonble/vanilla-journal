...
<form method="post">
    ...
    <table>
        ...
        <tr>
            <td>您的登入密碼：</td>
            <td><input name="password" type="password" value="" size="50" /></td>
        </tr>
        <tr>
            <td>請再輸入一次密碼：</td>
            <td><input name="password2" type="password" value="" size="50" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><input type="submit" name="submit" value="繼續安裝" /></td>
        </tr>
    </table>
...
?>
        ...
        <p><strong>Vanilla Journal</strong> 這套系統，可以幫助您輕鬆建立一套屬於您自己的線上期刊，包含上傳文章、調整分類順序、上傳圖片與附件…等各項功能。而首先，我們需要在 MySQL
            資料庫中，加入一些必要的資料庫欄位。</p>
        <p>如果您需要安裝的相關協助，您可以查看 Vanilla Journal 專案網頁上的<a
                href="http://code.google.com/p/vanilla-journal/wiki/InstallVanillaJournal">安裝說明</a>。</p>
